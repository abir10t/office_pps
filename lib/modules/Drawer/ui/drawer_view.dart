...
import '../controller/drawer_logic.dart';
...
class DrawerPage extends GetView<DrawerLogic> {
  ...
  Widget build(BuildContext context) {
    var Administrator = [
      drawerItemWidget(
          title: 'Users', icon: 'assets/images/administrator_1.png'),
      drawerItemWidget(
          title: 'Employee List', icon: 'assets/images/administrator_2.png'),
      drawerItemWidget(
          title: 'Role Permission', icon: 'assets/images/administrator_3.png'),
      drawerItemWidget(
          title: 'Supplier List', icon: 'assets/images/administrator_4.png'),
      drawerItemWidget(
          title: 'Client List', icon: 'assets/images/administrator_5.png'),
      drawerItemWidget(
          title: 'Bank List', icon: 'assets/images/administrator_6.png'),
      drawerItemWidget(
          title: 'Subcontractor List',
          icon: 'assets/images/administrator_7.png'),
      drawerItemWidget(
          title: 'Department List', icon: 'assets/images/administrator_8.png'),
      drawerItemWidget(
          title: 'Activity List', icon: 'assets/images/administrator_9.png'),
    ];
    ...
    return BaseWidget(
      builder: (context, sizingInformation) {
        return Scaffold(
          ...
          drawer: Theme(
            data: Theme.of(context).copyWith(canvasColor: ColorConstants.sectionPrimaryColor, //This will change the drawer background to blue.
              //other styles
            ),
            child: Drawer(
              child: ListView(
  ...
  Widget drawerheaderWidget(
      {required String icon, required String title, required List listName}) {
